...
//***************************************************************************************************
  ...
  // //distance = -0.0903*average_sensor_val + 65.306; //old IR sensor function
  // distance = (pow(2, -9)*pow(average_sensor_val, 4)) - (pow(2, -6)*pow(average_sensor_val, 3)) + (0.0009*pow(average_sensor_val, 2)) - (0.1766*average_sensor_val) + 17.943; //new IR sensor function
